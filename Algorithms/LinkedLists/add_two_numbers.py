...
solution = Solution()
print(solution.addTwoNumbers(create_linked_list_from_list([1, 2, 3]), create_linked_list_from_list([4, 5, 6])))
print(solution.addTwoNumbers(create_linked_list_from_list([9]), create_linked_list_from_list([9])))